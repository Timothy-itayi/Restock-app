...
// import { useSessionRepository } from '../../../_infrastructure/_supabase/SupabaseHooksProvider';
...
export const HistorySection: React.FC<HistorySectionProps> = ({ userId }) => {
  ...
  const { findCompletedByUserId } = useSessionRepository() as SessionRepository;
...
function useSessionRepository(): SessionRepository {
