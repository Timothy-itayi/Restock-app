...
export const getRestockSessionsStyles = (theme: AppColors) => StyleSheet.create({
  // Main container with notepad background - Responsive for iPad
  container: {
    flex: 1,
    paddingTop: theme.device.isTablet ? 80 : 60,
    backgroundColor: theme.colors.neutral.lighter, // Warm paper background
    overflow: "scroll",
  ...
  startButton: {
    backgroundColor: theme.colors.brand.primary, // Green for progress
  ...
  sessionList: {
    flex: 1,
    flexDirection: theme.device.isTablet ? 'row' : 'column',
    flexWrap: theme.device.isTablet ? 'wrap' : 'nowrap',
    justifyContent: theme.device.isTablet ? 'flex-start' : 'space-between',
  ...
  sessionCard: {
    ...
    marginHorizontal: theme.device.isTablet ? 0 : theme.layout.paddingHorizontal,
    borderWidth: 1,
    borderColor: theme.colors.neutral.light,
    shadowColor: "#000000",
    ...
    shadowRadius: 4,
    elevation: 2,
    flex: theme.device.isTablet ? 0 : 1,
    minWidth: theme.device.isTablet ? 300 : '100%',
    maxWidth: theme.device.isTablet ? 400 : '100%',
  },
  ...
  divider: {
    height: 1,
    backgroundColor: theme.colors.neutral.light, // Divider
    marginVertical: 0,
  },
  ...
  addProductButton: {
    backgroundColor: theme.colors.brand.primary, // Brand green
    width: 140,
    height: 90,
    borderRadius: 20,
    borderWidth: 1,
  ...
  productItem: {
    backgroundColor: theme.colors.neutral.lightest, // Pure white for contrast
    borderRadius: 12,
    padding: 16,
    marginBottom: 12,
    borderWidth: 1,
    borderColor: theme.colors.neutral.light, // Light grey border
    shadowColor: "#000000",
    shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.05,
    shadowRadius: 4,
  ...
  deleteButton: {
    backgroundColor: theme.colors.status.error, // Red for delete
    paddingHorizontal: 12,
    paddingVertical: 6,
    borderRadius: 6,
    borderWidth: 1,
  ...
  quantityButton: {
    ...
    height: 44,
    borderRadius: 22,
    backgroundColor: theme.colors.brand.primary, // Primary color for tappable buttons
    borderWidth: 1,
    borderColor: theme.colors.brand.primary,
    alignItems: "center",
    justifyContent: "center",
  ...
  quantityButtonText: {
    fontSize: 20,
    fontWeight: "600",
    color: theme.colors.neutral.lightest, // White text on colored button
  },

  // Quantity display
  quantityDisplay: {
    backgroundColor: theme.colors.neutral.lighter, // Light background to distinguish from buttons
    borderWidth: 1,
    borderColor: theme.colors.neutral.light,
    borderRadius: 12,
    paddingHorizontal: 24,
  ...
  // Suggestion item
  suggestionItem: {
    backgroundColor: theme.colors.neutral.lighter, // Very light grey
    paddingHorizontal: 16,
    paddingVertical: 12,
    borderRadius: 8,
    marginBottom: 4,
  ...
  integratedAddButtonIcon: {
    fontSize: 18,
    color: theme.colors.neutral.medium, // Grey color like the reference
    marginRight: 12,
    fontWeight: "500",
  },
  ...
  errorMessage: {
    backgroundColor: theme.colors.neutral.lighter, // Very light grey
    borderWidth: 1,
    borderColor: theme.colors.status.error, // Red border
    borderRadius: 8,
    padding: 12,
    marginBottom: 20,
  },
  ...
  errorText: {
    ...typography.bodySmall,
    color: theme.colors.status.error, // Red text
    textAlign: "center",
  },
  ...
  bottomFinishSection: {
    ...
    backgroundColor: theme.colors.neutral.lighter, // Slightly warmer paper
    borderTopWidth: 1,
    borderTopColor: theme.colors.neutral.light, // Light grey border
    paddingHorizontal: 20,
    paddingVertical: 16,
  ...
  emailReadyPrimaryButton: {
    flex: 2,
    backgroundColor: theme.colors.brand.primary, // Green for primary action
    paddingVertical: 14,
    borderRadius: 8,
    flexDirection: "row",
    alignItems: "center",
  ...
  notificationSuccess: {
    backgroundColor: theme.colors.status.success, // Green for success
  },
  ...
  notificationInfo: {
    backgroundColor: theme.colors.status.info, // Blue for info
  },
  
  notificationInfoIcon: {
    backgroundColor: theme.colors.status.info, // Use same family
  },
  
  notificationWarning: {
    backgroundColor: theme.colors.status.warning, // Amber for warning
  },
  ...
  notificationError: {
    backgroundColor: theme.colors.status.error, // Red for error
  },
  
  notificationErrorIcon: {
    backgroundColor: theme.colors.status.error, // Darker red
  },
  ...
  retryButton: {
    backgroundColor: theme.colors.brand.primary, // Green for retry
    paddingHorizontal: 24,
    paddingVertical: 12,
    borderRadius: 8,
    borderWidth: 1,
...
export const useRestockSessionsTheme = () => {
  return {
    styles: getRestockSessionsStyles(theme),
    appTheme,
  };
};